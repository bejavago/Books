...
import re
import bcrypt
from login.models import User1, Book1
...
def CreateNewBook(request): # POST /bookss/create
    Book2 = Book1.objects.create(title=request.POST['title'], network=request.POST['network'], release_date=request.POST['release_date'], description=request.POST['description'])
